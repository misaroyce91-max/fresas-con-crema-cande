...
export default function RootLayout({children}:{children:React.ReactNode}){return <html lang="es"><body><PwaRegister/><AuthProvider><StoreProvider><CartProvider>{children}<Nav/></CartProvider></StoreProvider></AuthProvider></body></html>}
